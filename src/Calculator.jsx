  ...
  return (
    <div className="calculator">
      ...
      <div className="calculator-buttons">
        <button className="calculator-button function" onClick={clear}>C</button>
        <button className="calculator-button function" onClick={() => performOperation('/')}>/</button>
        <button className="calculator-button function" onClick={() => performOperation('*')}>×</button>
        <button className="calculator-button function" onClick={() => performOperation('-')}>-</button>
        ...
        <button className="calculator-button operator row-span" onClick={handleEquals}>=</button>
        ...
        <button className="calculator-button col-span" onClick={() => inputDigit(0)}>0</button>
